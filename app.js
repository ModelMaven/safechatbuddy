...
const DEFAULT_CLIENT_ID = '373979148011-8v6m5k8g4g7r3p06euhvgrn22kcrbms5.apps.googleu/**
 * -------------------------------------------------------------
 * DRIVESYNC CHAT - CLIENT LOGIC
 * A decentralized, serverless, live-syncing chat application
 * -------------------------------------------------------------
...
sercontent.com'; // Google OAuth Sandbox Client ID
const DEFAULT_POLL_INTERVAL = 2000; // 2 seconds
const ALLOWED_EMAILS = []; // Add emails to restrict access, e.g. ['your-email@gmail.com']. Leave empty to allow any user.
...
function setupEventListeners() {
  ...
  // Mobile UI controls
  els.btnMobileMenu.addEventListener('click', () => els.sidebar.classList.add('mobile-open'));
  els.btnMobileClose.addEventListener('click', () => els.sidebar.classList.remove('mobile-open'));
}
